...
const MensShows = () => {
  ...
  const MensShowsRef = useRef(null);

  // Scroll left and right handlers
  const scrollLeft = () => {
    MensShowsRef.current.scrollBy({ left: -300, behavior: "smooth" });
  };
  ...
  return (
    ...
    <div className="relative w-full bg-gray-100 py-6">
         <h2 className=" text-2xl pl-5 font-bold">Men's Shoos</h2>
      {/* Scroll Left Button */}
      <button
      ...
      <div className="w-full overflow-x-auto" ref={MensShowsRef}style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
